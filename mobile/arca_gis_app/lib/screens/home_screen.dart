      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ...
            ListTile(leading: const Icon(Icons.psychology), title: const Text('IA terrain'),
              subtitle: const Text('Conseiller, diagnostic, planificateur'),
              onTap: () { Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (_) => const AiTerrainScreen())); }),
            ...
            ListTile(leading: const Icon(Icons.hive), title: const Text('Agriculture étendue'),
              subtitle: const Text('Apiculture, aquaculture, semencier'),
              onTap: () { Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (_) => const AgroHubScreen())); }),
            ListTile(leading: const Icon(Icons.shield), title: const Text('Résilience & urgences'),
              subtitle: const Text('Refuges, EWS, inondation'),
              onTap: () { Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (_) => const ResilienceScreen())); }),
            ListTile(leading: const Icon(Icons.eco), title: const Text('Crédits carbone'),
              onTap: () { Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (_) => const CarbonScreen())); }),
            const Divider(),
